const ContactForm = () => {
    ...
    <div className="form-group">
            ...
            <input className="form-control" name="first_name" id="first_name" type="text" /></div>
    </div>
    <div className="clear"> </div>
    </div>
    <div className="row">
    <div className="col">
    <div className="form-group"><label>Last Name: <span className="required">*</span></label>
    <input className="form-control" name="last_name" id="last_name" type="text" required="" /></div>
     </div>
    <div className="clear"> </div>
    </div>
    <div className="row">
    ...
    <input className="form-control" name="phone_mobile" id="phone_mobile" type="text" /></div>
     </div>
    <div className="clear"> </div>
    </div>
    <div className="row">
    ...
    <input className="form-control" name="email1" id="email1" type="email" /></div>
    </div>
    <div className="clear"> </div>
    </div>
    <div className="row">
    ...
    <input className="form-control" name="website" id="website" type="text" /></div>
     </div>
    <div className="clear"> </div>
    </div>
    <div className="row">
    ...
    <div className="form-group"><label></label><br />
...
<div className="clear"> </div>
    ...
    <button className="theme-btn btn-style-one mb-30 contactbump" name="Submit" type="submit" value="Submit"  /><span className="btn-title-new">SEND MESSAGE</span></button>
    <div className="clear"> </div>
    </div>
