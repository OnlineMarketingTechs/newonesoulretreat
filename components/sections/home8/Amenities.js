            ...
            <section className="banner-section style-eight">
                <Swiper className="banner-carousel theme_carousel owl-theme">
                    ...
                    <SwiperSlide className="slide-item">
                        <div className="image-layer lazy-image" data-bg="/assets/images/background/colorado-ayahuasca-retreat-view.webp">
                        </div>
                        <div className="auto-container ">
                            <div className="content-box">
                               <div className="text-center">
                                    <h2 className="text-center">Breath Taking Beautiful Landscapes With Luxury Amenities Await.</h2>
                                    <h3 className="text hombanWOW">We offer the pinnicale retreat experience on your <b>transformative journey</b></h3>
