                        ...
                        <div className="top-inner clearfix">
                            <div className="top-left">
                                <div className="info-box">
                                    ...
                                    <h6>  Want it delivered?<a href="https://www.clover.com/online-ordering/journey-cafe-kailuakona"><i className="far fa-long-arrow-right" />Order Now</a></h6>
                                </div>
                            </div>
                            <div className="top-right clearfix">
                                ...
                                <div className="support-box">
                                    <h6><i className="fas fa-phone-volume" /><a href="tel:18087317194">+1 808 731-7194</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="outer-box">
                            ...
                            <div className="nav-right clearfix">
                                ...
                                <div className="btn-box">
                                    <a href="https://www.clover.com/online-ordering/journey-cafe-kailuakona" className="theme-btn btn-style-seven"><span className="btn-title">Our Menu</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
