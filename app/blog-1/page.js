...
export default function Home() {
    ...
    return (
        <>
            ...
            <Breadcrumb_Services breadcrumbTitle="Online Marketing Blog That Focuses on Amplifying Results and Client Success Stories" pageTitle="The Marketing Multiplier " pageImage="assets/images/automation-analyatics-reporting.jpg" />
                        ...
                        <div className="auto-container">
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-14.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Business</div>
                                            <ul className="post-meta">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-15.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Projects</div>
                                            <ul className="post-meta">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-16.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Marketing</div>
                                            <ul className="post-meta">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-17.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Business</div>
                                            <ul className="post-meta">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-18.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Projects</div>
                                            <ul className="post-meta">
                                ...
                                <div className="col-lg-4 col-md-6 news-block-two">
                                    <div className="inner-box">
                                        <div className="image">
                                            <Link href="/blog-details"><img className="lazy-image owl-lazy" src="/assets/images/resource/news-19.jpg" alt="" /></Link>
                                        </div>
                                        <div className="lower-content">
                                            <div className="category">Marketing</div>
                                            <ul className="post-meta">
